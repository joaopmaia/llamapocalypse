...
function Pipes:_init (args)
  ...
  self._ypipes = math.random(450,550)
end

function Pipes:draw ()
  love.graphics.draw(self._sprites, self._quads[self._sprite_control], (self:get_x() + self:get_width()), self._ypies, 0, -3, 3)
end
